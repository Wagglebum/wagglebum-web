...
Play 모드에서 `Window > WagSave > Editor`를 열고 **Debugger**로 이동합니다. **Save Content** 패널에는 활성 씬의 모든 `WagSaveComponent`, 각각에 설정된 저장 항목 수, 그리고 **Configure** 및 **Focus** 버튼이 표시됩니다.
